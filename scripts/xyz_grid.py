...
axis_options = [
    ...
    AxisOption("RX-DPM enable", str, apply_override('rx_dpm_enable', boolean=True), choices=boolean_choice(reverse=True)),
    AxisOption("RX-DPM block size", int, apply_override("rx_dpm_block_size")),
    AxisOption("RX-DPM order", float, apply_override("rx_dpm_order")),
    AxisOption("RX-DPM mix orders", str, apply_override("rx_dpm_mix_orders")),
