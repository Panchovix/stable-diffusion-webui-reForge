...
axis_options = [
    ...
    AxisOption("Euler A2 extrapolation", float, apply_override("euler_a2_extrapolation"), confirm=confirm_range(0.0, 1.5, "Euler A2 extrapolation")),
    AxisOption("Euler A4 extrapolation", float, apply_override("euler_a4_extrapolation"), confirm=confirm_range(0.0, 1.5, "Euler A4 extrapolation")),
    AxisOption("Euler A2X extrapolation", float, apply_override("euler_a2x_extrapolation"), confirm=confirm_range(0.0, 1.5, "Euler A2X extrapolation")),
    ...
    AxisOption("Dynamic clip skip use schedule", str, apply_override('dynamic_clip_skip_use_schedule', boolean=True), choices=boolean_choice(reverse=True)),
    AxisOption("Dynamic clip skip schedule", str, apply_override('dynamic_clip_skip_schedule_values')),
