...
def detect_unet_config(state_dict, key_prefix):
    ...
    h_input = '{}encoder_hid_proj.weight'.format(key_prefix)
    if h_input in state_dict_keys:
        unet_config["image_model"] = "kolors"
        unet_config["encoder_hid_dim"] = state_dict[h_input].shape[1]
