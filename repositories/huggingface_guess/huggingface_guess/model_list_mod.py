...
class SD15(BASE):
    ...
    def process_vae_state_dict(self, state_dict):
        ...
        for x in k:
            if x.startswith("vae."):
                y = x.replace("vae.", "first_stage_model.")
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        replace_prefix = {}
        replace_prefix["text_encoders.clip_l."] = "clip_l."
...
class SD20(BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        replace_prefix = {}
        replace_prefix["text_encoders.clip_h."] = "clip_h."
...
class SDXL(BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        replace_prefix["text_encoders.clip_l."] = "clip_l."
        replace_prefix["text_encoders.clip_g."] = "clip_g."
        state_dict = utils.state_dict_prefix_replace(state_dict, replace_prefix, filter_keys=True)
