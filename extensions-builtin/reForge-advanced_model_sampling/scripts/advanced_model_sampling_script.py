...
# from backend.modules import model_sampling_backported
        ...
        with gr.Accordion(open=False, label=self.title()):
            ...
            def update_visibility(mode):
                return (
                    ...
                    gr.update(visible=(mode == "Continuous V")),
                    gr.update(visible=(mode == "Stable Cascade")),
                    gr.update(visible=(mode == "SD3")),
                    gr.update(visible=(mode == "Aura Flow")),
                    gr.update(visible=(mode == "Flux"))
                )
