...
class NeverOOMForForge(scripts.Script):
    ...
    def process(self, p, *script_args, **kwargs):
        ...
        model_management.VAE_ENCODE_TILE_SIZE_X = (
            model_management.VAE_ENCODE_TILE_SIZE_Y
        ) = encoder_tile_size
        model_management.VAE_DECODE_TILE_SIZE_X = (
            model_management.VAE_DECODE_TILE_SIZE_Y
        ) = decoder_tile_size
