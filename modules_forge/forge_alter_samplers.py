...
class AlterSampler(sd_samplers_kdiffusion.KDiffusionSampler):
    def __init__(self, sd_model, sampler_name, solver=None, rtol=None, atol=None):
        ...
        sampler_functions = {
            ...
            'euler_a4': k_diffusion_sampling.sample_euler_a4,
            'euler_a2x': k_diffusion_sampling.sample_euler_a2x,
...
samplers_data_alter = [
    ...
    sd_samplers_common.SamplerData('Euler A2', build_constructor(sampler_name='euler_a2'), ['euler_a2'], {}),
    sd_samplers_common.SamplerData('Euler A4', build_constructor(sampler_name='euler_a4'), ['euler_a4'], {}),
    sd_samplers_common.SamplerData('Euler A2X', build_constructor(sampler_name='euler_a2x'), ['euler_a2x'], {}),
