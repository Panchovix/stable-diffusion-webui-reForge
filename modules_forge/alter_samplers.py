...
import k_diffusion.sampling as k_diffusion_sampling
...
class AlterSampler_alt(sd_samplers_kdiffusion.KDiffusionSampler):
...
def build_constructor(sampler_name):
    def constructor(m):
        return AlterSampler_alt(m, sampler_name)
