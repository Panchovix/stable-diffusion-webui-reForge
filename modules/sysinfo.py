...
def get_dict():
    ...
    disabled_extensions = (
        config.get("disabled_extensions", []) if isinstance(config, dict) else []
    )
    ...
    res = {
        ...
        "Extensions": get_extensions(
            enabled=True, fallback_disabled_extensions=disabled_extensions
        ),
        "Inactive extensions": get_extensions(
            enabled=False, fallback_disabled_extensions=disabled_extensions
        ),
