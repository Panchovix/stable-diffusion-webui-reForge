...
samplers_data_k_diffusion = [
    ...
    or hasattr(sampling, funcname)
    or hasattr(sd_samplers_kdiffusion_smea, funcname)
]
...
class KDiffusionSampler(sd_samplers_common.Sampler):
    def __init__(self, funcname, sd_model, options=None):
        ...
        if callable(funcname):
            ...
            raise ValueError(
                f"Sampler {funcname} not found in k_diffusion.sampling or sd_samplers_kdiffusion_smea"
            )
