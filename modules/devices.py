...
device_hat: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_dat: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_srformer: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_grl: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_omnisr: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_span: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_compact: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_codeformer: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_rcan: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
device_plksr: torch.device = memory_management.get_torch_device()  # will be managed by memory management system
