...
device_interrogate: torch.device = (
    model_management.text_encoder_device()
)  # for backward compatibility, not used now
device_gfpgan: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_esrgan: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_hat: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_dat: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_srformer: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_grl: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_omnisr: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_span: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_compact: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
device_codeformer: torch.device = (
    model_management.get_torch_device()
)  # will be managed by memory management system
