...
options_templates.update(options_section(('sampler-params', "reForge Sampler Parameters", "sd"), {
    ...
    "sure_adam_mode": OptionInfo("none", "SURE - adam_mode (adaptive gradient method)", gr.Radio, {"choices": ["none", "adam", "adamw"]}, infotext='SURE adam_mode').info('none = plain SGD; adam = Adam; adamw = Adam + decoupled WD'),
