...
class BasicScheduler:
    ...
    def get_sigmas(self, model, scheduler, steps, denoise):
        ...
        sigmas = ldm_patched.modules.samplers.calculate_sigmas(
...
class BetaSamplingScheduler:
    ...
    def get_sigmas(self, model, steps, alpha, beta):
        sigmas = ldm_patched.modules.samplers.beta_scheduler(
...
class Noise_RandomNoise:
    ...
    def generate_noise(self, input_latent):
        ...
        return ldm_patched.modules.sample.prepare_noise(
            latent_image, self.seed, batch_inds
        )
...
class SamplerCustom:
    ...
    def sample(
        ...
        latent = latent.copy()
        latent_image = ldm_patched.modules.sample.fix_empty_latent_channels(
            model, latent_image
        )
...
class Guider_DualCFG(ldm_patched.modules.samplers.CFGGuider):
    ...
    def predict_noise(self, x, timestep, model_options={}, seed=None):
        ...
        out = ldm_patched.modules.samplers.calc_cond_batch(
            self.inner_model,
        ...
        return (
            ldm_patched.modules.samplers.cfg_function(
                self.inner_model,
                out[1],
                out[0],
                self.cfg2,
