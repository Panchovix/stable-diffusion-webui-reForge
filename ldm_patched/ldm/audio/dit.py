...
class FourierFeatures(nn.Module):
    ...
    def forward(self, input):
        f = (
            ...
            * math.pi
            * input
            @ ldm_patched.modules.ops.cast_to_input(self.weight.T, input)
        )
...
class LayerNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        return F.layer_norm(
            x,
            x.shape[-1:],
            weight=ldm_patched.modules.ops.cast_to_input(self.gamma, x),
            bias=beta,
        )
...
class RotaryEmbedding(nn.Module):
    ...
    def forward(self, t):
        ...
        freqs = torch.einsum(
            "i , j -> i j", t, ldm_patched.modules.ops.cast_to_input(self.inv_freq, t)
        )
        ...
        scale = ldm_patched.modules.ops.cast_to_input(self.scale, t) ** rearrange(
            power, "n -> n 1"
        )
