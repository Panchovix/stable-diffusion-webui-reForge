...
class SD20(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(
            ...
            ldm_patched.modules.text_encoders.sd2_clip.SD2ClipModel,
        )
...
class SDXL(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        if (
            ...
            state_dict["clip_g.text_projection"] = state_dict.pop(
...
class SD3(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        return supported_models_base.ClipTarget(
            ...
            ldm_patched.modules.text_encoders.sd3_clip.sd3_clip(
                clip_l=clip_l, clip_g=clip_g, t5=t5, dtype_t5=dtype_t5
            ),
        )
...
class StableAudio(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(
            ...
            ldm_patched.modules.text_encoders.sa_t5.SAT5Model,
        )
...
class AuraFlow(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(
            ...
            ldm_patched.modules.text_encoders.aura_t5.AuraT5Model,
        )
...
class HunyuanDiT(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(
            ...
            ldm_patched.modules.text_encoders.hydit.HyditModel,
        )
...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        if t5_key in state_dict:
            dtype_t5 = state_dict[t5_key].dtype
        return supported_models_base.ClipTarget(
            ldm_patched.modules.text_encoders.flux.FluxTokenizer,
            ldm_patched.modules.text_encoders.flux.flux_clip(dtype_t5=dtype_t5),
        )
